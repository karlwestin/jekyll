...
h3. About this particular fork

This fork is modified for the purpose of updating your site via a synced dropbox folder. This requires the content to be placed in a separate folder. If you do not wish to do this, you are probably better off using the "original version":https://github.com/mojombo/jekyll

I will post more info on how to set up the dropbox syncing. If you can't wait, contact me and i can show you.
// Karl
...
h3. Installing this specific version

* Clone git repository
* gem build jekyll.gemspec
* gem install jekyll-(version no).gem

"More info about this":http://stackoverflow.com/questions/2577346/how-to-install-gem-from-github-source
